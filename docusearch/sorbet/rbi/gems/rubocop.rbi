...
module RuboCop::PathUtil
  ...
  def self.relative_paths_cache=(arg0); end
...
class RuboCop::Cop::Base
  ...
  def begin_investigation(processed_source, offset: nil, original: nil); end
...
class RuboCop::Cop::Commissioner
  ...
  def investigate(processed_source, offset: nil, original: nil); end
...
module RuboCop::Cop::Documentation
  ...
  def self.url_for(cop_class, config = nil); end
  def url_for(cop_class, config = nil); end
end
...
class RuboCop::Cop::Generator
  ...
  def initialize(name, output: nil); end
...
module RuboCop::Cop::RangeHelp
  ...
  def range_by_whole_lines(range, include_final_newline: nil, buffer: nil); end
  ...
  def range_with_surrounding_space(range_positional = nil, range: nil, side: nil, newlines: nil, whitespace: nil, continuations: nil, buffer: nil); end
...
module RuboCop::Cop::FirstElementLineBreak
  def check_children_line_break(node, children, start = nil, ignore_last: nil); end
  def check_method_line_break(node, children, ignore_last: nil); end
...
module RuboCop::Cop::MinBranchesCount
  def if_conditional_branches(node, branches = nil); end
...
module RuboCop::Cop::MultilineElementLineBreaks
  def all_on_same_line?(nodes, ignore_last: nil); end
  def check_line_breaks(_node, children, ignore_last: nil); end
end
...
module RuboCop::Cop::SurroundingSpace
  def empty_brackets?(left_bracket_token, right_bracket_token, tokens: nil); end
  ...
  def on_new_investigation; end
  def reposition(src, pos, step, include_newlines: nil); end
  def side_space_range(range:, side:, include_newlines: nil); end
...
module RuboCop::Cop::VisibilityHelp
  ...
  def visibility_inline_on_def?(param0 = nil); end
  def visibility_inline_on_method_name?(param0 = nil, method_name:); end
  extend RuboCop::AST::NodePattern::Macros
end
...
class RuboCop::Cop::IfThenCorrector
  ...
  def if_node; end
  def indentation; end
  def initialize(if_node, indentation: nil); end
  def replacement(node = nil, indentation = nil); end
...
class RuboCop::Cop::ParenthesesCorrector
  def self.add_heredoc_comma(corrector, node); end
  def self.correct(corrector, node); end
  def self.extend_range_for_heredoc(node, range); end
  def self.handle_orphaned_comma(corrector, node); end
  def self.heredoc?(node); end
  def self.next_char_is_question_mark?(node); end
  def self.only_closing_paren_before_comma?(node); end
  def self.parens_range(node); end
...
class RuboCop::Cop::Gemspec::DependencyVersion < RuboCop::Cop::Base
  ...
  def add_dependency_method_declaration?(param0 = nil); end
  def allowed_gem?(node); end
  def allowed_gems; end
  def forbidden_offense?(node); end
  def forbidden_style?; end
...
class RuboCop::Cop::Gemspec::DevelopmentDependencies < RuboCop::Cop::Base
  def add_development_dependency?(param0 = nil); end
  def forbidden_gem?(gem_name); end
  def gem?(param0 = nil); end
...
class RuboCop::Cop::Gemspec::RequireMFA < RuboCop::Cop::Base
  ...
  def true_string?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::GemspecHelp
end
...
class RuboCop::Cop::Lint::ConstantOverwrittenInRescue < RuboCop::Cop::Base
  def on_resbody(node); end
  def overwritten_constant(param0 = nil); end
  def self.autocorrect_incompatible_with; end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::RangeHelp
end
...
class RuboCop::Cop::Lint::DeprecatedClassMethods < RuboCop::Cop::Base
  def deprecated_class_method?(param0 = nil); end
...
class RuboCop::Cop::Lint::DeprecatedOpenSSLConstant < RuboCop::Cop::Base
  ...
  def digest_const?(param0 = nil); end
  def message(node); end
  def on_send(node); end
...
class RuboCop::Cop::Lint::MissingSuper < RuboCop::Cop::Base
  ...
  def class_new_block(param0 = nil); end
...
class RuboCop::Cop::Lint::NextWithoutAccumulator < RuboCop::Cop::Base
  def on_block(node); end
  def on_block_body_of_reduce(param0 = nil); end
  def on_numblock(node); end
  def on_numblock_body_of_reduce(param0 = nil); end
...
class RuboCop::Cop::Lint::NonAtomicFileOperation < RuboCop::Cop::Base
  ...
  def on_send(node); end
  def receiver_and_method_name(param0 = nil); end
...
class RuboCop::Cop::Lint::RedundantRequireStatement < RuboCop::Cop::Base
  ...
  def on_send(node); end
  def pp_const?(param0 = nil); end
  def redundant_feature?(feature_name); end
  def redundant_require_statement?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::RangeHelp
end
class RuboCop::Cop::Lint::RedundantSafeNavigation < RuboCop::Cop::Base
  ...
  def conversion_with_default?(param0 = nil); end
  def on_csend(node); end
  def on_or(node); end
...
class RuboCop::Cop::Lint::UselessRuby2Keywords < RuboCop::Cop::Base
  ...
  def method_definition(param0 = nil, param1); end
  def on_send(node); end
end
...
class RuboCop::Cop::Metrics::ParameterLists < RuboCop::Cop::Base
  ...
  def on_def(node); end
  def on_defs(node); end
  def struct_new_or_data_define_block?(param0 = nil); end
end
...
class RuboCop::Cop::Naming::FileName < RuboCop::Cop::Base
  ...
  def regex; end
  def struct_definition(param0 = nil); end
...
class RuboCop::Cop::Style::ArrayIntersect < RuboCop::Cop::Base
  def active_support_bad_intersection_check?(param0 = nil); end
  def bad_intersection_check?(node); end
  def message(receiver, argument, method_name); end
  def on_send(node); end
  def regular_bad_intersection_check?(param0 = nil); end
...
class RuboCop::Cop::Style::AutoResourceCleanup < RuboCop::Cop::Base
  ...
  def file_open_method?(param0 = nil); end
  def on_send(node); end
end
...
class RuboCop::Cop::Style::CollectionCompact < RuboCop::Cop::Base
  ...
  def reject_method_with_block_pass?(param0 = nil); end
...
class RuboCop::Cop::Style::ComparableClamp < RuboCop::Cop::Base
  def array_min_max?(param0 = nil); end
  def autocorrect(corrector, node, prefer); end
  def if_elsif_else_condition?(param0 = nil); end
...
class RuboCop::Cop::Style::DataInheritance < RuboCop::Cop::Base
  ...
  def data_define?(param0 = nil); end
  def on_class(node); end
...
class RuboCop::Cop::Style::DocumentationMethod < RuboCop::Cop::Base
  def check(node); end
  def modifier_node?(param0 = nil); end
  def on_def(node); end
  def on_defs(node); end
...
class RuboCop::Cop::Style::EachForSimpleLoop < RuboCop::Cop::Base
  def each_range(param0 = nil); end
  def each_range_with_zero_origin?(param0 = nil); end
  def each_range_without_block_argument?(param0 = nil); end
  def offending?(node); end
  def on_block(node); end
  extend RuboCop::Cop::AutoCorrector
end
class RuboCop::Cop::Style::EachWithObject < RuboCop::Cop::Base
  ...
  def each_with_object_block_candidate?(param0 = nil); end
  def each_with_object_numblock_candidate?(param0 = nil); end
...
class RuboCop::Cop::Style::ExactRegexpMatch < RuboCop::Cop::Base
  ...
  def exact_regexp_match(param0 = nil); end
...
class RuboCop::Cop::Style::GuardClause < RuboCop::Cop::Base
  ...
  def register_offense(node, scope_exiting_keyword, conditional_keyword, guard = nil); end
...
class RuboCop::Cop::Style::HashEachMethods < RuboCop::Cop::Base
  ...
  def each_arguments(param0 = nil); end
  def format_message(method_name, current); end
  def kv_each(param0 = nil); end
  def kv_each_with_block_pass(param0 = nil); end
...
class RuboCop::Cop::Style::HashExcept < RuboCop::Cop::Base
  ...
  def bad_method_with_active_support?(param0 = nil); end
  def bad_method_with_poro?(param0 = nil); end
...
class RuboCop::Cop::Style::OpenStructUse < RuboCop::Cop::Base
  ...
  def on_const(node); end
  def uses_open_struct?(param0 = nil); end
end
...
class RuboCop::Cop::Style::RedundantArrayConstructor < RuboCop::Cop::Base
  def on_send(node); end
  def redundant_array_constructor(param0 = nil); end
...
class RuboCop::Cop::Style::RedundantFilterChain < RuboCop::Cop::Base
  ...
  def select_predicate?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Style::RedundantRegexpConstructor < RuboCop::Cop::Base
  def on_send(node); end
  def redundant_regexp_constructor(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Style::RequireOrder < RuboCop::Cop::Base
  ...
  def if_inside_only_require(param0 = nil); end
...
class RuboCop::Cop::Style::RedundantParentheses < RuboCop::Cop::Base
  ...
  def allowed_pin_operator?(param0 = nil); end
...
class RuboCop::Cop::Style::RedundantSortBy < RuboCop::Cop::Base
  def on_block(node); end
  def on_numblock(node); end
  def redundant_sort_by_block(param0 = nil); end
  def redundant_sort_by_numblock(param0 = nil); end
...
class RuboCop::Cop::Style::SafeNavigation < RuboCop::Cop::Base
  ...
  def ternary_safe_navigation_candidate(param0 = nil); end
...
class RuboCop::Cop::Style::Semicolon < RuboCop::Cop::Base
  ...
  def on_new_investigation; end
  def range_nodes; end
  def register_semicolon(line, column, after_expression, token_before_semicolon = nil); end
  def self.autocorrect_incompatible_with; end
...
class RuboCop::Cop::Style::YAMLFileRead < RuboCop::Cop::Base
  def offense_range(node); end
  def on_send(node); end
  def yaml_file_read?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Style::ZeroLengthPredicate < RuboCop::Cop::Base
  ...
  def nonzero_length_comparison(param0 = nil); end
  def on_send(node); end
  def other_receiver(param0 = nil); end
  def replacement(node); end
  def zero_length_comparison(param0 = nil); end
...
class RuboCop::Formatter::SimpleTextFormatter::Report
  ...
  def corrections; end
  def files; end
  def initialize(file_count, offense_count, correction_count, correctable_count, rainbow, safe_autocorrect: nil); end
  def offenses; end
  def rainbow; end
  def summary; end
  include RuboCop::Formatter::Colorizable
...
class RuboCop::Runner
  ...
  def self.default_ruby_extractor; end
...
class RuboCop::Lsp::Routes
  ...
  def for(name); end
  def format_file(file_uri, command: nil); end
...
class RuboCop::TargetRuby::GemspecFile < RuboCop::TargetRuby::Source
  ...
  def find_version; end
  def gem_requirement_versions(param0 = nil); end
