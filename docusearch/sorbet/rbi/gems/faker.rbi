...
class Faker::Internet < Faker::Base
  def self._deprecated_free_email(name: nil); end
  def self._deprecated_safe_email(name: nil); end
  ...
  def self.free_email(*args, **, &block); end
  ...
  def self.safe_email(*args, **, &block); end
...
class InvalidName___Class_0x00___UnavailableInEra_8 < StandardError
end
