...
module Faraday::Deprecate
  def deprecate(name, repl, ver, custom_message = nil); end
  def self.deprecate(name, repl, ver, custom_message = nil); end
  def self.skip; end
...
class Faraday::Connection
  ...
  def _deprecated_token_auth(token, options = nil); end
